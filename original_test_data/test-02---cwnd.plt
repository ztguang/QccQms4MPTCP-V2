...
# /bin/cp /opt/note/paper/xxu/paper/paper-2/gnuplot/test-02---cwnd.plt /root/文档/paper2---original--test--data---20210729---OK/
# /bin/cp /opt/note/paper/xxu/paper/paper-2/gnuplot/test-02---cwnd.plt /mnt/hdd/data/新乡学院/paper/paper-2---testing---results---20210729/paper2---original--test--data---20210729---OK
...
# gnuplot < test-02---cwnd.plt  > test-02---cwnd.png
# eog     test-02---cwnd.png &
# display test-02---cwnd.png &
...
# awk 'NR%136==1' test-02-def-cubic-qoe03-0.10.txt---wlan0 > test-02-def-cubic-qoe03-0.10.txt---wlan0---0.x-lines
...
set key spacing 1.1 font ",12" at 390,40 bottom left samplen 5		# Increasing the value of <some number> should increase the distance between titles.
plot \
...
set key spacing 1.1 font ",12" at 480,16 bottom left samplen 5		# Increasing the value of <some number> should increase the distance between titles.
plot \
