...
# /bin/cp /opt/note/paper/xxu/paper/paper-2/gnuplot/test-04---times.plt /root/文档/paper2---original--test--data---20210729---OK/
# /bin/cp /opt/note/paper/xxu/paper/paper-2/gnuplot/test-04---times.plt /mnt/hdd/data/新乡学院/paper/paper-2---testing---results---20210729/paper2---original--test--data---20210729---OK
...
# gnuplot < test-04---times.plt  > test-04---times.png
# eog     test-04---times.png &
# display test-04---times.png &
...
set key spacing 1.1 font ",11" at -1.26,200 bottom left samplen 1.6		# Increasing the value of <some number> should increase the distance between titles.
